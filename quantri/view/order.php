    ...
    <main class="content">
            ...
            <div class="right">
                <div>
                    <select name="trangthai">
                        ...
                        <option value="htat">Hoàn tất</option>
                        <option value="huykh">Hủy bởi khách hàng</option>
                        <option value="huynv">Hủy bởi người bán</option>
                    </select>
                </div>
                <div class="srch">
                    <input type="text" placeholder="Tìm kiếm theo ID, tên Khách Hàng đã mua hàng..." name='kyw'>
        ...
        <!--Start: Data table-->
            ...
            <tr>
                ...
                <td>
                    <?php 
                    if($trangthai==="cho") echo '<span class="status orange">Chờ duyệt</span></td>';
                    else if($trangthai==="vc") echo '<span class="status blue">Đang vận chuyển</span></td>';
                    else if($trangthai==="htat") echo '<span class="status green">Hoàn tất</span></td>';
                ...
                ?>
                        <a href="../controller/printInvoice.php?idDH=<?=$idDH?>" class="action-button print_order">
