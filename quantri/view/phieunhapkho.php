...
?>
        <main class="content">
            ...
            <div class="right">
                <div class="srch">
                    <input type="text" placeholder="Tìm kiếm theo ID của phiếu hoặc Tên của NCC..." name='kyw'>
             ...
             <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="../controller/printGRN.php?idPN=<?=$idPN?>" class="action-button print_order">
