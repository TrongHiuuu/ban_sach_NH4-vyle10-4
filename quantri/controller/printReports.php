            ...
            case 'doanhthu':
                ...
                //Table
                    ...
                    for($i = 1; $i <= sizeof($weeks); $i++) {
                        ...
                        /* orderCount */
                        $orderCount = getOrderCount($dateWeekStart, $dateWeekEnd)['tongsodon'];
                        if($orderCount == null) $orderCount = 0;
                        /* orderCount */

                        /* qtyCount */
                        $qtyCount = getQuantityCount($dateWeekStart, $dateWeekEnd)['tongsp'];
                        if($qtyCount == null) $qtyCount = 0;
                        /* qtyCount */

                        /* orderTotal */
                        $orderTotal = getOrderTotal($dateWeekStart, $dateWeekEnd)['tongtien'];
            ...
            case "loinhuan":
                ...
                //Table
                    ...
                    for($i = 1; $i <= sizeof($weeks); $i++) {
                        ...
                        if($orderCount == null)
                        $orderCount = 0;
                        else $orderCount = $orderCount['tongsodon'];
                        /* orderCount */
                        ...
                        if($orderTotal == null)
                        $orderTotal = 0;
                        else $orderTotal = $orderTotal['tongtien'];
                        /* orderTotal */
                        ...
                        if($grnTotal == null)
                        $grnTotal = 0;
                        else $grnTotal = $grnTotal['tongtiennhap'];
                        /* grnTotal */
            ...
            case "nhapkho":
                ...
                //Table
                    ...
                    for($i = 1; $i <= sizeof($weeks); $i++) {
                        ...
                        if($grnCount == null)
                        $grnCount = 0;
                        else $grnCount = $grnCount['tongdonnhap'];
                        /* grnCount */
